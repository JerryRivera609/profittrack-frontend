...
## Dashboard financiero consolidado de empresa

### GET `/api/empresas/dashboard-financiero-owner`

Funcion: devuelve en una sola respuesta el estado financiero completo de la empresa del usuario autenticado.
...
No lleva body. Usa la empresa del usuario autenticado.
...
- Totales financieros de la empresa.
- Semaforo y alertas globales.
- Rentabilidad por proyecto.
- Ultimos ingresos y egresos.
